...
- The `componet(folder)` which consist off all reusable component used around the project and api calls

- The `page(folder)` which consist of all the pages of the project

- The `types(folder)` which consist of all the types used in this project
